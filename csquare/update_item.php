...
if (isset($_POST["update_item_submit"])) {
    ...
    // Prepare and execute the SQL query to update the item data
    $sql = "UPDATE item 
    ...
    if ($conn->query($sql) === true) {
        ...
        // Redirect to the item page after a successful update
...
// Fetch item data for the selected item_id
if (isset($_GET["id"])) {
    $item_id = $_GET["id"];
    ...
    if ($result->num_rows == 1) {
        ...
        exit(); // Exit if the item is not found or if multiple items are found (which should not happen)
    }
} else {
    echo "<p class='text-danger text-center'>Invalid request.</p>";
    exit(); // Exit if the item ID is not provided in the URL
}
?>
    ...
    <div class="row justify-content-center">
        <div class="col-md-6">
            ...
            <form action="update_item.php" method="POST">
                ...
                <!-- Add input fields to edit the item details -->
                <div class="mb-3">
